        ...
        <div className="flex-1 lg:w-[68%] flex flex-col min-w-0 border-r border-theme overflow-y-auto p-4 md:p-6">
          ...
          {activeTab !== 'add' && (
            <div className="relative mb-4 shrink-0">
              ...
              <input
                type="text"
                className="w-full rounded-xl pl-10 pr-8 py-2.5 text-[13px] bg-theme-input/50 border border-theme text-theme-primary focus:outline-none focus:border-(--accent-primary) focus:ring-2 focus:ring-(--accent-ring) placeholder-theme-muted transition-all duration-150"
                placeholder={
                  activeTab === 'pending'
          ...
          {activeTab === 'add' && (
            <div className="space-y-5 animate-fade-in flex-1 max-w-2xl">
              ...
              {/* Search Input */}
              <div className="add-friend-search-wrapper relative flex items-center bg-theme-input/40 border border-theme rounded-2xl transition-all duration-200">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2.5"
                  className="w-4.5 h-4.5 absolute left-3.5 top-1/2 -translate-y-1/2 text-theme-muted pointer-events-none shrink-0"
                >
                  <circle cx="11" cy="11" r="8" />
                  <line x1="21" y1="21" x2="16.65" y2="16.65" />
                </svg>
                <input
                  ...
                  type="text"
                  className="w-full pl-10.5 pr-10 py-3 text-[14px] bg-transparent border-none outline-none shadow-none text-theme-primary placeholder:text-theme-muted focus:outline-none focus:ring-0 focus:border-none"
                  style={{
                    border: 'none',
                    outline: 'none',
                    boxShadow: 'none',
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center justify-center w-7 h-7 rounded-lg bg-transparent border-none text-theme-muted hover:text-theme-primary hover:bg-theme-input/60 cursor-pointer transition-colors active-press"
                    title="Clear search"
                  >
                    <svg
                      viewBox="0 0 24 24"
