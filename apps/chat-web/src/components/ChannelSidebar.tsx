...
export const ChannelSidebar = ({
  ...
  return (
    <div className="glass-panel w-60 min-w-45 max-w-[calc(100vw-130px)] md:w-60 md:min-w-60 lg:w-70 lg:min-w-70 h-full flex flex-col overflow-hidden select-none transition-all duration-300 ease-in-out">
      {/* Group Header */}
